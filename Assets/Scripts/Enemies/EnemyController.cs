...
public class EnemyController : MonoBehaviour
{
    ...
    public void InvestigationScenarios() //I MAYBE DONT NEED THIS......
    {
        //RaycastHit2D hit = Physics2D.Linecast(eyePosition, jumpTarget, patrolMask);
        ...
        ////Scenario 2 - Jumping might be required for investigation, Different platforms, No Overlap.
        ...
        ////Scenario 3 - Jumping might be required for investigation, Different platforms, Overlap.
        //else if (patrolPlatform != targetPlatform && PlatformOverlap())
        //{
    ...
    public void ChaseScernarios() //I MAYBE DONT NEED THIS......
    {

    }

    public bool PlatformOverlap()//I MAYBE DONT NEED THIS.....
    {
        ...
        //    if ((targetPlatformBounds.max.x > patrolPlatformBounds.min.x && targetPlatformBounds.min.x < patrolPlatformBounds.min.x) 
        //        || (targetPlatformBounds.min.x < patrolPlatformBounds.max.x && targetPlatformBounds.max.x > patrolPlatformBounds.max.x))
        //    {
        //        return true;
        //    }
        return false;
